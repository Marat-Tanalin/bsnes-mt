...
namespace Instances {
	extern Instance<CheatDatabase> cheatDatabase;
	extern Instance<CheatWindow>   cheatWindow;
	extern Instance<StateWindow>   stateWindow;
	extern Instance<ToolsWindow>   toolsWindow;
}
