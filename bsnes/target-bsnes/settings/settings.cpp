...
auto SettingsWindow::create() -> void {
  ...
  panelList.append(ListViewItem().setText(bms::get("Settings.Video").data()).setIcon(Icon::Device::Display)); // "Video"
  panelList.append(ListViewItem().setText(bms::get("Settings.Audio").data()).setIcon(Icon::Device::Speaker)); // "Audio"
  panelList.append(ListViewItem().setText(bms::get("Settings.Input").data()).setIcon(Icon::Device::Joypad)); // "Input"
  panelList.append(ListViewItem().setText(bms::get("Settings.Hotkeys").data()).setIcon(Icon::Device::Keyboard)); // "Hotkeys"
  panelList.append(ListViewItem().setText(bms::get("Settings.Paths").data()).setIcon(Icon::Emblem::Folder)); // "Paths"
  panelList.append(ListViewItem().setText(bms::get("Settings.Emulator").data()).setIcon(Icon::Action::Settings)); // "Emulator"
  panelList.append(ListViewItem().setText(bms::get("Settings.Enhancements").data()).setIcon(Icon::Action::Add)); // "Enhancements"
  panelList.append(ListViewItem().setText(bms::get("Settings.Compatibility").data()).setIcon(Icon::Action::Remove)); // "Compatibility"
  panelList.append(ListViewItem().setText(bms::get("Settings.Drivers").data()).setIcon(Icon::Place::Settings)); // "Drivers"
  panelList.onChange([&] {
